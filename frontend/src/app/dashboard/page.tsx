      ...
      <div className="m-10">
        ...
        <div className="flex flex-row gap-10 mt-4 w-200">
          <div className="bg-[#212226] rounded-lg shadow-md font-bold p-6">
            <h1 className="mb-2 text-center">Carbono Emitido</h1>
            <div className="flex flex-row gap-10">
              <h1 className="text-center">-2,8%</h1>
              <img
          ...
          <div className="bg-[#212226] rounded-lg shadow-md font-bold gap-6 p-6">
            <h1 className="mb-2 text-center">Transporte</h1>
            <div className="flex flex-row gap-10">
            <h1>+5,3%</h1>
            <img
              className="w-24 h-32 -rotate-90"
          ...
          <div className="bg-[#212226] rounded-lg shadow-md font-bold gap-6 p-6">
            <h1 className="mb-2 text-center">Electricidad</h1>
            <div className="flex flex-row gap-10">
            <h1>+3,7%</h1>
            <img
              className="w-24 h-32 -rotate-90"
