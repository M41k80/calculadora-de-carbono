    ...
    <div className="flex justify-center items-center w-full mt-10 sm:mt-20">
      <div className="bg-[#202226] p-8 rounded-2xl shadow-md w-full max-w-lg text-white text-left">
        ...
        <p className="text-sm sm:text-base text-[#B1B1B1] mb-3 leading-relaxed font-light">
          Ahora ya podés analizarlos desde el dashboard, visualizar tendencias y
          generar predicciones con base en los consumos de tu empresa.
        </p>

        <p className="text-sm sm:text-base text-[#B1B1B1] mb-6 font-light">
          Si querés hacer ajustes o subir nuevos archivos, podés volver a esta
          sección en cualquier momento.
        </p>
        ...
        <div className="justify-between flex">
          ...
          <button
            onClick={onClose}
            className="bg-[#4C4C4C] hover:bg-neutral-700 text-white font-medium py-2 px-6 sm:px-10 rounded-xl transition cursor-pointer"
          >
